      ...
      <div className="Container">
        {dragon ? (
          ...
          <div className="treasureBox">
            ...
            <p>Gurl this treasure trove does not require a user to be logged in for access</p>
          </div>
        )}
        {user && username ? (
          <div className="treasureBox loggedIn">
          ...
          <div className="treasureBox">
            ...
            <p>Gurl this one requires a user to be logged in for access</p>
          </div>
        )}
        {all && username ? (
          <div className="treasureBox loggedIn">
          ...
          <div className="treasureBox">
            ...
            <p>Gurl this one requires you to be a logged in as an admin user for access</p>
          </div>
        )}
      </div>
    );
